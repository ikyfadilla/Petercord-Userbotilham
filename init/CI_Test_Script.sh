...
tg_sendinfo "<code>I am gonna merge staging into Petercord-Userbotilham</code>"
cd
...
tg_sendinfo "<code>I have merged all commits from staging into Petercord-Userbotilham</code>"
